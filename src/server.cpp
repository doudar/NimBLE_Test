...
void setup(void)
{
    ...
    pBikeCharacteristic->setValue("Only shows if less than 3 characteristics");
    ...
    ////////////////////////////////Adding any of the following characteristics will cause the client to not get notifications//////////////////
    /*
